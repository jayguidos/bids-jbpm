...
import com.bids.bpm.rest.client.cmds.AddWorkDoneCmd;
...
import com.bids.bpm.rest.client.cmds.ReportDeploymentStatusCmd;
import com.bids.bpm.rest.client.cmds.ReportProcessStatusCmd;
...
public class BidsServiceClient
{
    ...
    private Map<String, BSCommand<?>> makeCmds(String uriTemplate)
    {
        ...
        cmds.put(AddWorkDoneCmd.NAME, new AddWorkDoneCmd(clientFactory,uriTemplate));
